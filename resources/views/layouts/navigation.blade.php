<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @auth
                <x-responsive-nav-link :href="route('threads.create')" :active="request()->routeIs('threads.create')">
                    {{ __('New Thread') }}
                </x-responsive-nav-link>
            @endauth
        </div>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            ...
            @else
                <div class="px-4">
                    <a href="{{ route('login') }}" class="block text-sm text-blue-600 hover:text-blue-800">Login</a>
                    <a href="{{ route('register') }}" class="block text-sm text-blue-600 hover:text-blue-800">Register</a>
                </div>
            @endauth
        </div>
    </div>
